...
Widget fdTitleWidget({required title1, required title2, Function? onTap}) {
  return Row(
...
Widget fdAppBarWidget({BuildContext? context, required String title, List<Widget>? actions, double? elevation}) {
  return AppBar(
    elevation: elevation,
    title: Text(
      title,
