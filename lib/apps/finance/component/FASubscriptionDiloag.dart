      ...
      child: Column(
        ...
        children: [
          SettingItemWidget(
            ...
            leading: Image.asset(widget.subscriptionData!.image.validate(), height: 50, width: 50, fit: BoxFit.fill),
            title: widget.subscriptionData!.name.validate(),
            subTitle: "***123456",
          ),
          ...
          8.height,
          Text(widget.subscriptionData!.price.validate(), style: boldTextStyle(size: 28)).paddingOnly(left: 16, right: 16),
          16.height,
          Row(
