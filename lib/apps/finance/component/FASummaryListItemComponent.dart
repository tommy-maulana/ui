...
class FASummaryListItemComponent extends StatefulWidget {
  ...
  FASummaryListItemComponent({this.summaryData, this.index = 0});
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Image.asset(
              widget.summaryData!.image.validate(),
              height: 40,
              width: 40,
              fit: BoxFit.fill,
              color: Colors.white,
          ...
          8.height,
          Text(widget.summaryData!.name.validate(), style: boldTextStyle()),
          8.height,
          Text('SPENT', style: secondaryTextStyle(size: 12)),
          createRichText(
            list: [
              TextSpan(text: widget.summaryData?.discountAmount.validate(), style: boldTextStyle(size: 18)),
              TextSpan(text: " out of ${widget.summaryData?.originalAmount.validate()}", style: secondaryTextStyle()),
            ],
          ),
          16.height,
          ClipRRect(
