  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      child: Column(
        ...
        children: [
          Text(widget.deliveryCard!.title.validate(), style: primaryTextStyle()).expand(),
          8.height,
          Text(widget.deliveryCard!.price.validate(), style: boldTextStyle(size: 24)).expand(),
          30.height,
          Text(widget.deliveryCard!.estimateTime.validate(), style: secondaryTextStyle()).expand(),
          8.height,
