...
class _ModalBottomSheet<T> extends StatefulWidget {
  _ModalBottomSheet({Key? key, required this.route, required this.topOffset}) : super(key: key);
...
Future<T?> showModalBottomSheetCustom<T>({BuildContext? context, WidgetBuilder? builder, required double topOffset}) async {
  assert(context != null);
  assert(builder != null);
