...
List walkThroughList = [
  YGWalkThroughModel(url: yg_bodyStretch, text: 'Your Yoga', subtext: "Lorem ipsum, or lipsum as it is sometimes known, is"
      " dummy text used in laying out print,"
      " graphic or web designs. The passage is attributed to an unknown"),
  YGWalkThroughModel(url: yg_meditation, text: 'Your Healthy', subtext: "Lorem ipsum, or lipsum as it is sometimes known, is"
      " dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown"),
  YGWalkThroughModel(url: yg_food, text: 'Learning to Relax', subtext: "Lorem ipsum, or lipsum as it is sometimes known, is dummy "
...
List<YGCommentDataModel> commentList = [
  ...
  YGCommentDataModel(
      text: "Good Morning Guys...I've been long time ago Last time...But i have use this app for My daily practice",
      profileImage: yg_splash,
      date: '29-12-2020',
      name: "SaharaZs",
      image: imageDataList),
];
