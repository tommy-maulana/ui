                        ...
                        Row(
                          children: [
                            healthTopicDataList[index].isLike!
                                ? Icon(Icons.favorite_border,color: iconColorSecondary,)
                                : Icon(Icons.favorite, color: Colors.red).onTap(() {
                              healthTopicDataList[index].isLike = !healthTopicDataList[index].isLike!;
                              healthTopicDataList[index].isLike!
                                  ? healthTopicDataList[index].like = healthTopicDataList[index].like! - 1
                                  : healthTopicDataList[index].like = healthTopicDataList[index].like! + 1;
                              setState(() {});
                            }),
                            4.width,
                            ...
                            10.width,
                            Icon(MaterialCommunityIcons.comment_processing,color: iconColorSecondary,),
                            4.width,
