  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(icon: Icon(MaterialCommunityIcons.home,color: iconColorSecondary,), label: 'Home',),
          BottomNavigationBarItem(icon: Icon(Ionicons.md_play,color:  iconColorSecondary,), label: 'Training'),
          BottomNavigationBarItem(icon: Icon(Icons.library_books_rounded,color: iconColorSecondary), label: 'HealthTips'),
          BottomNavigationBarItem(icon: Icon(Icons.add,color:  iconColorSecondary), label: 'Goal',),
