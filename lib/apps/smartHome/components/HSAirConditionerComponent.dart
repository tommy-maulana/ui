...
final customColors05 = CustomSliderColors(
    dotColor: HexColor('#424242'), trackColor: HexColor('#424242'), progressBarColors: [HexColor('#FF8E36'), HexColor('#F3D144')], shadowColor: HexColor('#FFB1B2'), shadowMaxOpacity: 0.05);
