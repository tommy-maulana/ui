  ...
  return Align(
    ...
    child: Container(
      ...
      child: Row(
        ...
        children: [
          commonCacheImageWidget(EGIconGoogle, _iconSize, width: _iconSize),
          commonCacheImageWidget(EGIconFB, _iconSize, width: _iconSize),
          commonCacheImageWidget(EGIconTwitter, _iconSize, width: _iconSize)
        ],
      ),
    ),
  );
