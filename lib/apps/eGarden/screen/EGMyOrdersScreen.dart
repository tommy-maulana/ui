                            ...
                            children: [
                              Container(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(listOfVoucher[index]['percentage'] as String, style: boldTextStyle(size: 30, color: white)),
                                    8.height,
                                    Text(listOfVoucher[index]['forWhat'] as String, style: boldTextStyle(size: 16, color: white))
                                  ],
                                ),
                              ).expand(flex: 3),
                              Container(
