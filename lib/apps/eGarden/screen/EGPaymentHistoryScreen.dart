                ...
                itemBuilder: (context, index) {
                  return Card(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        CircleAvatar(backgroundColor: EGPrimaryColor3, child: commonCacheImageWidget(historyList[index]["image"] as String?, 30)),
                        24.width,
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(historyList[index]["date"] as String, style: secondaryTextStyle(color: Colors.grey[350])),
                            4.height,
                            Text(historyList[index]["cardName"] as String, style: primaryTextStyle()),
                          ],
                        ).expand(),
                        Text(historyList[index]["amount"] as String, style: boldTextStyle(size: 16))
                      ],
