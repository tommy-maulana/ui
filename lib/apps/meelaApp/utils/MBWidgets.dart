...
Widget budgetCardWidget({required String bugTitle, String? amount, String? percentage, String? amount1, Color? color, double? width}) {
  return Container(
...
Widget settingRowWidget({required String name, IconData? icon, IconData? icon1}) {
  return Row(
    children: [
