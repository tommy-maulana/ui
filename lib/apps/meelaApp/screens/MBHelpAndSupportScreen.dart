  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        actions: [
          IconButton(icon: Icon(Icons.call, size: 24, color: appPrimaryColor), onPressed: () {}),
        ],
      ),
      body: Stack(
        children: [
          ...
          Align(
            ...
            child: Row(
              children: [
                ...
                16.width,
                Container(
                  decoration: boxDecorationWithShadow(boxShape: BoxShape.circle, backgroundColor: appPrimaryColor),
                  child: IconButton(
                    onPressed: () {
                      sendClick();
                    },
