      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            height: 250,
            decoration: boxDecorationDefault(color: Colors.white.withOpacity(0.3)),
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return CommonOptionData(
                  ...
                  setState(() {});
                }, borderRadius: BorderRadius.circular(HMCornerRadius)).paddingOnly(top: 16, left: 32, right: 32, bottom: 16);
              },
            )
          ],
        ),
          ...
          children: [
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                ).paddingOnly(top: 16, left: 32, right: 32, bottom: 16);
              },
            ),
          ],
        ),
