        ...
        children: [
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      commonCacheImageWidget(data.image, 100, width: 200, fit: BoxFit.cover).cornerRadiusWithClipRRectOnly(topLeft: 8, topRight: 8).expand(),
                      Text(
                        data.catName!,
          ...
          Container(
            ...
            child: Column(children: [
              ...
              Divider(thickness: 1, height: 32, color: appStore.isDarkModeOn ? appBarBackgroundColor : Theme.of(context).dividerColor),
              Row(
                children: [
                ...
                Container(
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text("Your review", style: secondaryTextStyle(color: HMFontColor400), overflow: TextOverflow.ellipsis).expand(),
                          data.isRated
                              ? RatingBar(
                                  ignoreGestures: true,
                                  itemSize: 16,
                      ...
                      Row(
                        children: [
                          Text("Total Price", style: secondaryTextStyle(color: HMFontColor400), overflow: TextOverflow.ellipsis).expand(),
                      ...
                      Row(
                        children: [
                          Text("DateTime", style: secondaryTextStyle(color: HMFontColor400), overflow: TextOverflow.ellipsis).expand(),
