        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              CommonCategoryContainer(recommendedList: recommendedList, appBarTitle: 'Recommended for You'),
              Container(
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [Text("Moving into a New Home", style: boldTextStyle(size: 18)), Text("View All", style: boldTextStyle(color: hmColorPrimary))],
                ),
              ).paddingAll(HMAppPadding),
              CommonSubCategoryContainer(categoryData: moveHomeList, appBarTitle: 'Moving into a New home'),
              Container(
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
              ...
              CommonSubCategoryContainer(categoryData: essentialServiceList, appBarTitle: 'Essential Home Services'),
              Container(
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("Outdoor Upkeep", style: boldTextStyle(size: 18)),
                    Text("View All", style: boldTextStyle(color: hmColorPrimary)),
                  ],
                ),
              ).paddingAll(HMAppPadding),
              CommonSubCategoryContainer(categoryData: outdoorUpkeepList, appBarTitle: 'Outdoor Upkeep')
            ],
          ).paddingBottom(16),
        ),
      ),
