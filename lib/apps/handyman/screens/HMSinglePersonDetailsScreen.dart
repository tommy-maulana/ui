                ...
                Column(
                  children: [
                    ...
                    CommonSinglePersonDetail(
                      title: "About",
                      widgets: [
                        Text("I love what i do! Love the outdoors I'm always willing to go the extra mile to satisfy our customer. Call or message me for same day services.",
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            width: 45,
                            height: 45,
                            child: Icon(Icons.message_rounded, color: HMColorWhite),
                            decoration: BoxDecoration(color: hmColorPrimary),
                            ...
                            children: [
                              ...
                              Stack(
                                children: [
                                  ...
                                  Container(color: hmColorPrimary, width: (context.width() - 98) * 0.3, height: 25).cornerRadiusWithClipRRect(4)
                                ],
                              )
                            ],
                          ).paddingAll(4)
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Stack(children: [
                                  Container(
                                    width: (context.width() - 98) * 0.6,
                                    height: 10,
                                    decoration: boxDecorationDefault(color: Colors.white24),
                                  ).cornerRadiusWithClipRRect(8),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Icon(Icons.star, color: Colors.amber),
                                8.width,
                                Container(width: (context.width() - 98) * 0.6, height: 10, decoration: boxDecorationDefault(color: Colors.white24)).cornerRadiusWithClipRRect(8),
                                8.width,
                            ...
                            Column(
                              children: [
                                ...
                                8.height,
                                Text("What a great concept and value. I have wasted weeks trying interviewing.", style: primaryTextStyle(size: 16))
                              ],
                            ),
                            Divider(thickness: 1),
                            8.height,
