            ...
            Stack(
              children: [
                profileImage != null
                    ...
                    : CircleAvatar(radius: 50, backgroundImage: AssetImage(profileImage != null ? profileImage as String : RH_user)),
                Positioned(
                  bottom: 0,
                  right: 0,
                  child: Container(
  ...
  settingWidget(String icon, String title, String address, Function onPressed) {
    return Row(
      children: [
        ...
        IconButton(icon: Icon(Icons.navigate_next_outlined, color: Colors.grey), onPressed: onPressed as void Function()?)
      ],
    );
  }
