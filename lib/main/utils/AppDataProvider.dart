...
List<AppModel> getQRAndBarcodeScannerList() {
  ...
  list.add(AppModel(title: 'Bar Code Scanner', description: '', widget: QRCodeScannerScreen()));
...
List<AppModel> getFullAppsList() {
  List<AppModel> list = [];
  list.add(AppModel(title: 'Fitness App', description: 'Improve your Fitness Today', widget: FTSplashScreen(), isDarkModeSupported: true, themeType: ThemeTypeFullApp,tag: 'New'));
...
List<AppModel> getDrawerWidget() {
  List<AppModel> list = [];
  list.add(AppModel(title: 'Drawer 1', widget: MWDrawerScreen1(), isContainsScaffold: true, themeType: ThemeTypeComingSoon));
